			...
			<div className="max-w-3xl w-full px-6 text-center space-y-10">
				...
				<p className="text-zinc-500 text-sm">
					...
					com nossos <a className="text-zinc-300 underline" href="#">termos de uso</a> e <a
						className="text-zinc-300 underline" href="#">politicas de privacidade</a>.
				</p>
			</div>
				...
				<div className="fixed inset-0 bg-black/60 flex items-center justify-center">
					<div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
						<div className="space-y-2">
							...
							<p className="text-sm text-zinc-400">
								Para concluir a criação da viagem para Florianópolis, Brasil nas datas de 16 e 27 de Agosto de 2024 preencha seus dados abaixo:
							</p>
						</div>
